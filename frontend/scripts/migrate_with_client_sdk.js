...
try {
  ...
  firebaseApp = require(path.join(__dirname, '..', 'node_modules', 'firebase', 'app'));
  firebaseFirestore = require(path.join(__dirname, '..', 'node_modules', 'firebase', 'firestore'));
}
const { initializeApp } = firebaseApp;
const { getFirestore, doc, writeBatch, setDoc } = firebaseFirestore;
...
const exportDir = fs.existsSync(path.join(__dirname, '..', 'firestore_export'))
  ? path.join(__dirname, '..', 'firestore_export')
  : path.join(__dirname, '..', 'frontend', 'firestore_export');
